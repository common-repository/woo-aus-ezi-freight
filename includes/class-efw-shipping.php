...
class EFWShipping extends WC_Shipping_Method {
	...
	public function calculate_shipping( $package = array() ) {
		...
		if($valid_license !== true) {
			$valid_tip = '<a href="http://www.ezihosting.com">Woo Aus EZi Freight</a> by <a href="http://www.ezihosting.com/woocommerce-australian-freight-extension/">EZiHosting</a>. For all your design and Hosting needs.<br />';

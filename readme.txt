...
Version 1.1.0 - Fix bug: Make the lower rate parcel has more priority.

Version 1.1.1 - Update the license valid server url.

Version 1.1.2 - Update the Interparcel Legacy API url. The old API will change on Sunday 14 May 2017, please update ASAP.

Version 1.1.3 - Fix bug: fix the compatibility issue with WooCommerce 3.4.4.


== Upgrade Notice ==
You can have an advert free version of Woo Aus EZi Freight by visiting the following webpage:
https://www.ezihosting.com/woocommerce-australian-freight-extension/